...
def through_imagess():
    ...
    return Response(gen1(img,capacity1),mimetype='multipart/x-mixed-replace; boundary=frame')
...
def gen():
    ...
    while (cap.isOpened()):
        ...
        for(x,y,w,h) in faces:
            ...
            '''if i<=capacity:
                flash("capacity is in limit")
            else:
                flash("capacity limit exceeded")'''
            #print(img,i)
